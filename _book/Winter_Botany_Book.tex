...
\addcontentsline{toc}{subsection}{Key 1.2: Leaves strictly opposite, scale like (Cupressaceae)}
...
\addcontentsline{toc}{chapter}{Key 2: Leaves evergreen, parallel veined (Asparagaceae)}
...
\chapter*{Key 3: Leaves or leaf scars whorled}\label{key-3-leaves-or-leaf-scars-whorled}}
\addcontentsline{toc}{chapter}{Key 3: Leaves or leaf scars whorled}
...
\item
  ...
  \end{enumerate}
\item
  Leaves tough \textgreater{}6mm wide, strongly retrorsely scabrid \ldots{} \emph{Rubia}
\item
...
\addcontentsline{toc}{chapter}{Key 4: Leaves or leaf scars opposite}
...
\addcontentsline{toc}{section}{Key 4.1: Climbing, or epiphytic plants parasitic on trees}
...
\addcontentsline{toc}{section}{Key 4.2: Evergreen plants}
...
\addcontentsline{toc}{subsection}{Key 4.2.1: Wiring, creeping, trailing shrubs}
...
\addcontentsline{toc}{subsection}{Key 4.2.2: Shrubs, trees. Leaves simple}
...
\addcontentsline{toc}{subsection}{Key 4.2.3: Shrubs, trees. Leaves toothed}
...
\addcontentsline{toc}{section}{Key 4.3: Deciduous plants}
...
\addcontentsline{toc}{subsection}{Key 4.3.1: Bundle trace 1}
...
\addcontentsline{toc}{subsection}{Key 4.3.2: Bundle traces 3}
...
\addcontentsline{toc}{subsection}{Key 4.3.3: Bundle traces \textgreater{}3}
